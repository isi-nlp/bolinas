# Represent Trees
# Adapted from NLTK trunk/nltk/tree.py r 8834 Copyright (C) 2001-2011 NLTK Project
# Original Author: Edward Loper <edloper@gradient.cis.upenn.edu>
#                  Steven Bird <sb@csse.unimelb.edu.au>
#                  Nathan Bodenstab <bodenstab@cslu.ogi.edu> (tree transforms)
# URL: <http://www.nltk.org/>
# For license information, see LICENSE.TXT
#
#      Removes all dependencies on NLTK so that this file can be shipped with 
#       Bolinas.
...
#####################################################################
# Wrapper for parse tree Nonterminals.
#####################################################################
...
# copied from nltk.internals.py, copyright see above.
######################################################################
